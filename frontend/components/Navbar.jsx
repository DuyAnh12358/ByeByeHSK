    ...
    <div className="navbar bg-[#141416] text-[#a0a0a5] h-20 px-4 sm:px-8 border-b border-zinc-800 sticky top-0 z-50">
      ...
      <div className="navbar-start gap-2">
        ...
        <div className="dropdown lg:hidden">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-50 p-2 shadow-2xl bg-[#1c1c1e] rounded-box w-52 text-gray-300 gap-y-1 border border-zinc-800">
            ...
            <li>
              <a href="#" className="justify-between">
                Luyện thi HSK
                <span className="badge badge-sm bg-[#e06d53] border-none text-white text-[9px] uppercase font-bold">Mới</span>
              </a>
            </li>
          </ul>
        </div>
        ...
        <a href="#" className="flex items-center gap-3 hover:opacity-95 transition-opacity">
          {/* Tên thương hiệu với mã màu hồng/coral chuẩn */}
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 gap-x-6 text-sm font-semibold text-[#dddddf]">
          <li>
            <a href="#" className="hover:text-white hover:bg-[#d67b7b] transition-colors py-2 px-3 rounded-lg">Luyện tập</a>
          </li>
          <li>
            <a href="#" className="hover:text-white hover:bg-[#d67b7b] transition-colors py-2 px-3 rounded-lg">Từ vựng</a>
          </li>
          <li>
            <a href="#" className="hover:text-white hover:bg-[#d67b7b] transition-colors py-2 px-3 rounded-lg">Ngữ pháp</a>
          </li>
          
          {/* Mục "Luyện thi HSK" đi kèm Badge "MỚI" đặt tuyệt đối lên góc */}
          <li className="relative">
            <a href="#" className="hover:text-white hover:bg-[#d67b7b] transition-colors py-2 px-3 rounded-lg">
              Luyện thi HSK
      ...
      <div className="navbar-end gap-3 text-[#dddddf]">
        ...
        {/* Nút hành động Đăng nhập */}
        <a href="#" className="text-sm font-bold text-white hover:text-[#d67b7b] transition-colors pl-2">
          Đăng nhập
        </a>
      </div>
